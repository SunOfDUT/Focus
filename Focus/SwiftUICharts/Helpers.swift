...
//    public init(backgroundColor: Color? = nil,accentColor: Color? = nil, gradientColor: GradientColor? = nil, textColor: Color? = nil, legendTextColor: Color? = nil, dropShadowColor: Color? = nil){
//        self.backgroundColor = backgroundColor != nil ?  backgroundColor!:.white
//        self.accentColor = accentColor != nil ?  accentColor!:.black
//        self.gradientColor =  gradientColor != nil ?  gradientColor!:GradientColor(start: .orange, end: .orange)
//        self.textColor = textColor != nil ?  textColor!:.black
//        self.legendTextColor = legendTextColor != nil ?  legendTextColor!:.black
//        self.dropShadowColor = dropShadowColor != nil ?  dropShadowColor!:.black
//    }
...
func GetCos(degree:Double) -> Double{
    return cos((degree * .pi) / 180)
}

func GetSin(degree:Double) -> Double{
